...
var ASM_CONSTS = {
  89998: () => { if (document.fullscreenElement) return 1; },  
 90044: () => { return Module.canvas.width; },  
 90076: () => { return parseInt(Module.canvas.style.width); },  
 90124: () => { document.exitFullscreen(); },  
 90151: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 90223: () => { if (document.fullscreenElement) return 1; },  
 90269: () => { return Module.canvas.width; },  
 90301: () => { return screen.width; },  
 90326: () => { document.exitFullscreen(); },  
 90353: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90547: () => { return window.innerWidth; },  
 90573: () => { return window.innerHeight; },  
 90600: () => { if (document.fullscreenElement) return 1; },  
 90646: () => { return Module.canvas.width; },  
 90678: () => { return parseInt(Module.canvas.style.width); },  
 90726: () => { if (document.fullscreenElement) return 1; },  
 90772: () => { return Module.canvas.width; },  
 90804: () => { return screen.width; },  
 90829: () => { return window.innerWidth; },  
 90855: () => { return window.innerHeight; },  
 90882: () => { if (document.fullscreenElement) return 1; },  
 90928: () => { return Module.canvas.width; },  
 90960: () => { return screen.width; },  
 90985: () => { document.exitFullscreen(); },  
 91012: () => { if (document.fullscreenElement) return 1; },  
 91058: () => { return Module.canvas.width; },  
 91090: () => { return parseInt(Module.canvas.style.width); },  
 91138: () => { document.exitFullscreen(); },  
 91165: ($0) => { Module.canvas.style.opacity = $0; },  
 91203: () => { return screen.width; },  
 91228: () => { return screen.height; },  
 91254: () => { return window.screenX; },  
 91281: () => { return window.screenY; },  
 91308: () => { return window.devicePixelRatio; },  
 91344: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91397: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91448: () => { Module.canvas.style.cursor = 'none'; },  
 91485: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91741: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91792: () => { if (document.pointerLockElement) return 1; },  
 91839: () => { if (document.fullscreenElement) return 1; },  
