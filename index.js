...
var ASM_CONSTS = {
  90094: () => { if (document.fullscreenElement) return 1; },  
 90140: () => { return Module.canvas.width; },  
 90172: () => { return parseInt(Module.canvas.style.width); },  
 90220: () => { document.exitFullscreen(); },  
 90247: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 90319: () => { if (document.fullscreenElement) return 1; },  
 90365: () => { return Module.canvas.width; },  
 90397: () => { return screen.width; },  
 90422: () => { document.exitFullscreen(); },  
 90449: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90643: () => { return window.innerWidth; },  
 90669: () => { return window.innerHeight; },  
 90696: () => { if (document.fullscreenElement) return 1; },  
 90742: () => { return Module.canvas.width; },  
 90774: () => { return parseInt(Module.canvas.style.width); },  
 90822: () => { if (document.fullscreenElement) return 1; },  
 90868: () => { return Module.canvas.width; },  
 90900: () => { return screen.width; },  
 90925: () => { return window.innerWidth; },  
 90951: () => { return window.innerHeight; },  
 90978: () => { if (document.fullscreenElement) return 1; },  
 91024: () => { return Module.canvas.width; },  
 91056: () => { return screen.width; },  
 91081: () => { document.exitFullscreen(); },  
 91108: () => { if (document.fullscreenElement) return 1; },  
 91154: () => { return Module.canvas.width; },  
 91186: () => { return parseInt(Module.canvas.style.width); },  
 91234: () => { document.exitFullscreen(); },  
 91261: ($0) => { Module.canvas.style.opacity = $0; },  
 91299: () => { return screen.width; },  
 91324: () => { return screen.height; },  
 91350: () => { return window.screenX; },  
 91377: () => { return window.screenY; },  
 91404: () => { return window.devicePixelRatio; },  
 91440: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91493: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91544: () => { Module.canvas.style.cursor = 'none'; },  
 91581: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91837: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91888: () => { if (document.pointerLockElement) return 1; },  
 91935: () => { if (document.fullscreenElement) return 1; },  
 91981: () => { return window.innerWidth; },  
 92007: () => { return window.innerHeight; }
};
