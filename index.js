...
var ASM_CONSTS = {
  90014: () => { if (document.fullscreenElement) return 1; },  
 90060: () => { return Module.canvas.width; },  
 90092: () => { return parseInt(Module.canvas.style.width); },  
 90140: () => { document.exitFullscreen(); },  
 90167: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 90239: () => { if (document.fullscreenElement) return 1; },  
 90285: () => { return Module.canvas.width; },  
 90317: () => { return screen.width; },  
 90342: () => { document.exitFullscreen(); },  
 90369: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 90563: () => { return window.innerWidth; },  
 90589: () => { return window.innerHeight; },  
 90616: () => { if (document.fullscreenElement) return 1; },  
 90662: () => { return Module.canvas.width; },  
 90694: () => { return parseInt(Module.canvas.style.width); },  
 90742: () => { if (document.fullscreenElement) return 1; },  
 90788: () => { return Module.canvas.width; },  
 90820: () => { return screen.width; },  
 90845: () => { return window.innerWidth; },  
 90871: () => { return window.innerHeight; },  
 90898: () => { if (document.fullscreenElement) return 1; },  
 90944: () => { return Module.canvas.width; },  
 90976: () => { return screen.width; },  
 91001: () => { document.exitFullscreen(); },  
 91028: () => { if (document.fullscreenElement) return 1; },  
 91074: () => { return Module.canvas.width; },  
 91106: () => { return parseInt(Module.canvas.style.width); },  
 91154: () => { document.exitFullscreen(); },  
 91181: ($0) => { Module.canvas.style.opacity = $0; },  
 91219: () => { return screen.width; },  
 91244: () => { return screen.height; },  
 91270: () => { return window.screenX; },  
 91297: () => { return window.screenY; },  
 91324: () => { return window.devicePixelRatio; },  
 91360: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 91413: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91464: () => { Module.canvas.style.cursor = 'none'; },  
 91501: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 91757: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 91808: () => { if (document.pointerLockElement) return 1; },  
 91855: () => { if (document.fullscreenElement) return 1; },  
 91901: () => { return window.innerWidth; },  
 91927: () => { return window.innerHeight; }
};
